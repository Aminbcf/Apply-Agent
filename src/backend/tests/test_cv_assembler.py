import pytest
from AI.llm.cv_assembler import assemble_cv_latex, assemble_cv_markdown, validate_cv_sections
...
def test_assemble_cv_markdown():
    ...
    markdown = assemble_cv_markdown(sections)

    assert "# John Doe" in markdown
    assert "## Summary" in markdown
    assert "### Dev — Tech" in markdown
    assert "- Did stuff" in markdown
