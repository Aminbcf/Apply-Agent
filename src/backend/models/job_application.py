...
class JobApplication(Base):
    ...
    # Phase 7 – Job‑Match Scenario additions
    # Workflow: pending → accepted → rejected (independent of application status above)
    workflow_status: Mapped[str] = mapped_column(String, default="pending")

    # LaTeX source generated by the fine‑tuned Qwen model
    ...
    # True while pdflatex is running in the background
